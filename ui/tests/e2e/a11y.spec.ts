...
// T070 / SC-006: every asset view inside the shell, both themes, zero serious or
...
const routes = ['/asset',  '/asset/categories',  '/asset/suppliers',  '/asset/locations',  '/asset/consumables',  '/asset/licenses',  '/asset/insurance',  '/asset/inventory-sync',  '/asset/dashboard']

test.describe('asset accessibility', () => {
