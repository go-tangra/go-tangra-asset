// Standalone development entry: mounts the asset routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'Asset (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())
