...
func (AuditLog) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "asset_audit_logs"},
...
func (AuditLog) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("tenant_id").StorageKey("asset_auditlog_tenant_id"),
		index.Fields("tenant_id", "client_id").StorageKey("asset_auditlog_tenant_client"),
		index.Fields("tenant_id", "operation").StorageKey("asset_auditlog_tenant_operation"),
		index.Fields("tenant_id", "success").StorageKey("asset_auditlog_tenant_success"),
		index.Fields("operation").StorageKey("asset_auditlog_operation"),
		index.Fields("client_id").StorageKey("asset_auditlog_client_id"),
		index.Fields("success").StorageKey("asset_auditlog_success"),
		index.Fields("peer_address").StorageKey("asset_auditlog_peer_address"),
	}
}
