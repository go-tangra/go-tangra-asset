...
func (_q *LicenseQuery) QuerySupplier() *SupplierQuery {
...
func (_q *LicenseQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LicenseQuery) FirstIDX(ctx context.Context) string {
...
func (_q *LicenseQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LicenseQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *LicenseQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *LicenseQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LicenseQuery) WithSupplier(opts ...func(*SupplierQuery)) *LicenseQuery {
	query := (&SupplierClient{config: _q.config}).Query()
...
func (_q *LicenseQuery) prepareQuery(ctx context.Context) error {
	...
	if err := license.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *LicenseQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*License, error) {
	...
	if query := _q.withSupplier; query != nil {
		if err := _q.loadSupplier(ctx, query, nodes, nil,
			func(n *License, e *Supplier) { n.Edges.Supplier = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *LicenseQuery) loadSupplier(ctx context.Context, query *SupplierQuery, nodes []*License, init func(*License), assign func(*License, *Supplier)) error {
...
func (_q *LicenseQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(license.Table, license.Columns, sqlgraph.NewFieldSpec(license.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSupplier != nil {
			_spec.Node.AddColumnOnce(license.FieldSupplierID)
		}
	}
