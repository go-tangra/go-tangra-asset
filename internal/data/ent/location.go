...
// was not loaded in eager-loading.
func (e LocationEdges) AssetsOrErr() ([]*Asset, error) {
	if e.loadedTypes[2] {
		return e.Assets, nil
	}
...
// was not loaded in eager-loading.
func (e LocationEdges) ConsumablesOrErr() ([]*Consumable, error) {
	if e.loadedTypes[3] {
...
// QueryAssets queries the "assets" edge of the Location entity.
func (_m *Location) QueryAssets() *AssetQuery {
	return NewLocationClient(_m.config).QueryAssets(_m)
}

// QueryConsumables queries the "consumables" edge of the Location entity.
func (_m *Location) QueryConsumables() *ConsumableQuery {
	return NewLocationClient(_m.config).QueryConsumables(_m)
}
