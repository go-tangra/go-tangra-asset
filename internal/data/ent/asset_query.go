...
func (_q *AssetQuery) QueryCategory() *CategoryQuery {
...
func (_q *AssetQuery) QuerySupplier() *SupplierQuery {
...
func (_q *AssetQuery) QueryLocation() *LocationQuery {
...
func (_q *AssetQuery) QueryAssignments() *AssetAssignmentQuery {
...
func (_q *AssetQuery) WithCategory(opts ...func(*CategoryQuery)) *AssetQuery {
	query := (&CategoryClient{config: _q.config}).Query()
...
func (_q *AssetQuery) WithSupplier(opts ...func(*SupplierQuery)) *AssetQuery {
	query := (&SupplierClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithLocation(opts ...func(*LocationQuery)) *AssetQuery {
	query := (&LocationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithAssignments(opts ...func(*AssetAssignmentQuery)) *AssetQuery {
	query := (&AssetAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) prepareQuery(ctx context.Context) error {
	...
	if asset.Policy == nil {
		return errors.New("ent: uninitialized asset.Policy (forgotten import ent/runtime?)")
	}
...
func (_q *AssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Asset, error) {
	...
	if query := _q.withCategory; query != nil {
		if err := _q.loadCategory(ctx, query, nodes, nil,
			func(n *Asset, e *Category) { n.Edges.Category = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSupplier; query != nil {
		if err := _q.loadSupplier(ctx, query, nodes, nil,
			func(n *Asset, e *Supplier) { n.Edges.Supplier = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAssignments; query != nil {
		if err := _q.loadAssignments(ctx, query, nodes,
			func(n *Asset) { n.Edges.Assignments = []*AssetAssignment{} },
			func(n *Asset, e *AssetAssignment) { n.Edges.Assignments = append(n.Edges.Assignments, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AssetQuery) loadCategory(ctx context.Context, query *CategoryQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Category)) error {
...
func (_q *AssetQuery) loadSupplier(ctx context.Context, query *SupplierQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Supplier)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Asset)
	for i := range nodes {
...
func (_q *AssetQuery) loadLocation(ctx context.Context, query *LocationQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Location)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Asset)
	for i := range nodes {
...
func (_q *AssetQuery) loadAssignments(ctx context.Context, query *AssetAssignmentQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *AssetAssignment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(assetassignment.FieldAssetID)
	}
	query.Where(predicate.AssetAssignment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.AssignmentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AssetQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCategory != nil {
			_spec.Node.AddColumnOnce(asset.FieldCategoryID)
		}
		if _q.withSupplier != nil {
			_spec.Node.AddColumnOnce(asset.FieldSupplierID)
		}
