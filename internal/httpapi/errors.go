...
// Refusals (api/openapi/asset.yaml). ErrValidation and ErrConflict may
...
// reasons (repo sentinels), oversized bodies to 413, anything else to 503 (details logged only).
